...
Pour arangoDB donnée au format JSON sous des Collection, très ressamblant à l'organisation de mongoDB. Se rapprochant d'un noSQL un peu plus classique et perdant l'avantage d'un graphe full, car indexation en plus par rapport à la collection.
